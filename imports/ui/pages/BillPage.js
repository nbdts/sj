...
export default class BillPage extends Component {
  ...
  addToBill(newprod){
    ...
    this.setState({billprod},()=>{console.log(this.state.billprod)})
}
    ...
    return(
      ...
      <div className="admin-panel clearfix">
       <div className="slidebar">
         <ul>
           <li onClick={this.handleClick.bind(this,3)} ><a href="#" id="targeted"><Avatar  image="https://image.flaticon.com/icons/svg/167/167247.svg" text="Juice"/></a></li>
           ...
           <li onClick={this.handleClick.bind(this,1)} ><a href="#" id="targeted"><Avatar image="http://icons.iconarchive.com/icons/dapino/beach/256/icecream-icon.png" text="Icecream"/></a></li>
        </ul>
       </div>
            ...
            <div className="main box">
                ...
                <div id="MenuOptions" style={{display:'flex',flex:5,flexWrap:'wrap'}}>
                ...
                <div id="Bill" style={{display:'flex',flex:2,backgroundColor:"yellow",flexWrap:'wrap', flexFlow:"column"}}>
                <table>
                <thead>
                <tr>
                <th>Name</th>
                ...
                <tbody>
                {this.state.billprod.map((bill,i)=>{return (
                  <tr key={i}>
                  <td>{bill.name}</td>
                  <td>{bill.price}</td>
                  </tr>
